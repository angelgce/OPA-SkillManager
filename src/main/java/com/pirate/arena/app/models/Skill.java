...
public class Skill {
    ...
    public Skill(String id, String name, String description, String image, List<String> charactersLinked, List<SkillSet> skillSet, List<String> classes, String cooldown) {
        this.id = id;
        this.name = name;
